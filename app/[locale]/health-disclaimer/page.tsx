...
const DATA = LEGAL_PAGES.find((p) => p.slug === "health-disclaimer")!;
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return buildMetadata({ locale: l, path: "/health-disclaimer", title: DATA.title[l], description: DATA.description[l] });
}
