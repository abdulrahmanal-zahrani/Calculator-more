...
const DATA = LEGAL_PAGES.find((p) => p.slug === "financial-disclaimer")!;
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return buildMetadata({ locale: l, path: "/financial-disclaimer", title: DATA.title[l], description: DATA.description[l] });
}
