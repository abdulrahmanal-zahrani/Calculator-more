...
const COPY = {
  ar: {
    ...
    howItWorks: [
      ...
      "عدّل القهوة أو الماء أو النسبة مباشرة — نعيد حساب القيمتين الأخريين تلقائيًا.",
    ...
    faq: [
      { question: "هل النسبة ثابتة لكل طريقة؟", answer: "لا، النسبة المقترحة نقطة بداية فقط — يمكنك تعديلها دائمًا لتناسب ذوقك." },
