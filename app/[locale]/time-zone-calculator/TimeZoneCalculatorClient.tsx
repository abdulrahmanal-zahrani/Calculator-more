...
const COPY = {
  ar: {
    intro: "قارن التوقيت بين مدينتين حول العالم — يراعي الحساب التوقيت الصيفي تلقائيًا.",
    from: "من مدينة",
    to: "إلى مدينة",
    ...
    howItWorks: [
      ...
      "هذا يعني أن التوقيت الصيفي (DST) يُحتسب تلقائيًا لكل مدينة حسب تاريخها المحلي.",
    ],
    disclaimer: "الأوقات تُحسب حسب بيانات المناطق الزمنية القياسية — تحقق من مصدر رسمي لأحداث حساسة للوقت.",
    faq: [{ question: "هل يراعي التوقيت الصيفي؟", answer: "نعم، يعتمد على قاعدة بيانات IANA المدمجة في المتصفح والتي تحدّث تلقائيًا." }],
  },
  en: {
